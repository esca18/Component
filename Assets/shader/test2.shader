Shader "DefaultLighting"
{
	Properties 
	{
_color("_color", Color) = (0.9552239,0.0570283,0.6411694,1)
...
sampler2D _LightinRamp;
			...
			{
float4 Assemble0=float4(float4( 0.0, 0.0, 0.0, 0.0 ).x, float4( 0.0, 0.0, 0.0, 0.0 ).y, float4( 0.0, 0.0, 0.0, 0.0 ).z, float4( 0.0, 0.0, 0.0, 0.0 ).w);
